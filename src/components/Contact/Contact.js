...
import image from '../../images/baumaschinen-gmbh-overview.png';

function Contact() {
  return (
    <div className="relative flex items-top justify-center min-h-screen bg-white sm:items-center sm:pt-0 pt-20">
                    ...
                    <div className="grid items-center lg:grid-cols-2 p-5 lg:pl-10">
                        <div className="p-6 mr-2 bg-amber-50/40 rounded-lg backdrop-blur-sm drop-shadow-lg z-10">
                            ...
                            <div className="flex items-center mt-4 text-gray-600">
                                ...
                                <div className="ml-4 text-md tracking-wide font-semibold w-50">
                                    <a href="tel:03843212123" className="underline hover:text-gray-500">03843 212123</a> <br/>
                                    <a href="tel:03843215912" className="underline hover:text-gray-500">03843 215912</a> <br/>
                                    Fax: -215913
                                </div>
                            </div>
                            ...
                            <div className="flex items-center mt-2 text-gray-600">
                                ...
                                <div className="ml-4 text-md tracking-wide font-semibold w-40 lg:w-80 underline hover:text-gray-500">
                                <a href="mailto:info@dressler-baumaschinen.de">info@dressler-baumaschinen.de</a>
                                </div>
                            </div>
                        </div>
                        <div className="md:mb-12 lg:mb-0 z-20 lg:-ml-10 lg:w-3/4">
                                <img src={image}
                                    className="rounded-lg lg:w-5/6" alt="" />
                        </div>
                    </div>
                </div>
            </div>
